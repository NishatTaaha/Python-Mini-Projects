...
#icon
image_icon= PhotoImage(file='image recorder.png')
root.iconphoto(False,image_icon)

#
# #logo
# photo= PhotoImage(file='image recorder.png')
...
# entry box
duration= StringVar()
entry=Entry(root, textvariable=duration, font='arial 30', width=15).pack(padx=15, pady=15)
Label(text='Enter time in seconds', font='arial 15',background='#4a4a4a', fg='white').pack(padx=15, pady=15)
